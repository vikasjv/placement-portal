    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Coardinator Login</div>
            ...
            <div class="panel-body" >
                <form method="post" action="searchstudent.php">
                        ...
                        <div id="div_id_username" class="form-group required">
                                ...
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="name" placeholder="Enter name to search" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                      ...
                      <div class="form-group"> 
                            ...
                            <div class="controls col-md-8 ">
                                <input type="submit" align="center" name="submit" value="Search" class="btn btn-primary btn btn-info" id="submit-id-signup" />
                ...
                <form class="form-horizontal" role="form" method="post" action="placementevent.html">
                <a href="placementevent.html"
  <button type="submit" class="btn btn-primary btn-block" name='f30'>ADD PLACEMENT EVENT</button></a><hr>
